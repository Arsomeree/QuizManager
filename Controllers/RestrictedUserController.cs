...
{// Using permission roles to ensure only Restricted user can only see questions. Most views will not be utlised and will be controlled by the question controler

  [Authorize(Roles = "User")]
  public class RestrictedUserController : Controller
    {
